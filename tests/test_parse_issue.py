...
def test_parse_issue_returns_expected_dict() -> None:
    expected_return = {'project_card_id': '1793822382',
                       'assignee': {'login': 'Demian143', 'id': 81446007, 'node_id': 'MDQ6VXNlcjgxNDQ2MDA3', 'avatar_url': 'https://avatars.githubusercontent.com/u/81446007?v=4', 'gravatar_id': '', 'url': 'https://api.github.com/users/Demian143', 'html_url': 'https://github.com/Demian143', 'followers_url': 'https://api.github.com/users/Demian143/followers', 'following_url': 'https://api.github.com/users/Demian143/following{/other_user}', 'gists_url': 'https://api.github.com/users/Demian143/gists{/gist_id}', 'starred_url': 'https://api.github.com/users/Demian143/starred{/owner}{/repo}',
