...
def process_webhook(data):
    try:
        ...
        if issue:
            ...
            logger.info('Assignee login: %s', assignee_login)  # Add this line for debugging
            ...
            if existing_data:
                ...
                logger.info('Assignee value before saving: %s', all_data.assignee)  # Add this line for debugging
